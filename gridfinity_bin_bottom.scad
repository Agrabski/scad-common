...
//
// Usage:
//   use <gridfinity_bin_bottom.scad>
//   gridfinity_bin_bottom(cols = 2, rows = 3);              // plain
//   gridfinity_bin_bottom(cols = 2, rows = 3, magnets = true); // with magnets
//
...
gridfinity_bin_bottom(cols=COLUMNS, rows=ROWS, magnets=MAGNETS, skeletonize=SKELETONIZE);
